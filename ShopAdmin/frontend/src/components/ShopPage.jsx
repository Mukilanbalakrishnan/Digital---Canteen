...
const ShopPage = () => {
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto p-6 bg-white shadow-2xl rounded-2xl mt-12 cursor-default">
            ...
            <p className="text-xl border rounded border-gray-500 bg-gray-100 absolute top-4 right-4 font-semibold px-4 py-2  text-green-600 transition z-10 cursor-default">
            ...
            <button
                ...
                className="absolute mt-20 top-4 right-4 font-semibold px-4 py-2 bg-red-700 text-white rounded-md hover:bg-red-800 transition z-10"
            >
                Logout
            </button>
